...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        ...
        <p class="text-gray-600">Update insurance product information</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.products.update', $product->id) }}">
            ...
            <div class="mb-6">
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    @php
                        ...
                        $selectedCategories = old('categories', $product->categories ?? []);
                    @endphp
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="base_premium"
                    name="base_premium"
                    value="{{ old('base_premium', $product->base_premium) }}"
                    min="0"
                    step="1000"
                    required
